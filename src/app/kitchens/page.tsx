...
const serviceJsonLd = {
  ...
  "@type": "Service",
  "@id": `${SITE_URL}/kitchens#service`,
  name: "Кухні на замовлення",
  url: `${SITE_URL}/kitchens`,
  description:
    "Проєктування, виготовлення, доставка та встановлення кухонь за індивідуальними розмірами у Києві та передмісті.",
  provider: {
    "@type": "LocalBusiness",
  ...
  serviceType: "Кухні на замовлення",
};
